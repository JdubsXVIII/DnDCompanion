...
public class Character {
    ...
    public void setRace(String r) {
        ...
        if (race.equals("Dwarf")) {
            ...
            features.put("speed", "Your base walking speed is 30 feet.");
            features.put("Draconic Ancestry", "Choose one type of draconic ancestry table. Your breath weapon and damage resistance are determined by the draconic type.");
            features.put("Breath Weapon", "You can use your action to exhale destructive energy.Your daconic ancestory determines the size, shape,and damage type of the exhalation.");
            features.put("Damage Resistance", "You have resistance to the damage type associated with your draconic ancestory.");

        }else if(race.equals("Gnome")){
            features.put("speed", "Your base walking speed is 25 feet.");
            features.put("dark vision", "You can see in dim light within 60 feet of you as if you were bright light in a dark space");
            features.put("gnome cunning", "You have advatage on all Intellegence, Wisdom, and Charisma saving throws against magic");
            features.put("Subrace", "Two subraces of gnmes are found among the worlds of D&D: forest and rock gnomes. Choose one of these subraces.");

        }else if(race.equals("Half-Elf")){
            features.put("speed", "Your base walking speed is 30 feet.");
            features.put("dark vision", "You can see in dim light within 60 feet of you as if you were bright light in a dark space");
            features.put("Fey Ancestry", "You have advantage on saving throws against being charmed, and magic can't put you to sleep.");
            features.put("Skill Versatility", " You gain proficiency in two skills of your choice");

        }else if(race.equals("Half-Orc")){
            features.put("speed", "Your base walking speed is 30 feet.");
            features.put("dark vision", "You can see in dim light within 60 feet of you as if you were bright light in a dark space");
            features.put("Menacing", "You gain proficiency in the Intimidation skill.");
            features.put("Relentless Endurance", " When you are reduced to 0 hit points but not killed outright, you can drop to 1 hit point instead.");
            features.put("Savage Attacks", "When you score a critical hit with a melee weapon attack, you can roll one of the weapon's damage dice one additional time and add it to the extra damage of the critical hit.");

        }else if(race.equals("Tiefling")){
            features.put("speed", "Your base walking speed is 30 feet.");
            features.put("dark vision", "You can see in dim light within 60 feet of you as if you were bright light in a dark space");
            features.put("Hellish Resistance","You have resistance to fire damage.");
            features.put("Infernal Legacy","You know the thaumaturgy cantrip.When you reach 3rd level, you can cast the hellish rebuke spell as a 2nd level spell once with this traiy and regain the ability to do so when you finish a long rest");
